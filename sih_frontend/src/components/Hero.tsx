      ...
      <div className="container hero-inner">
        <div className="hero-copy">
          ...
          <p className="hero-subtext">
            Sahara helps identify early signs of psychological distress in survivors of
          ...
          <div className="hero-trust">
            ...
            <div className="hero-trust-item">
              ...
              <span>Verified by counsellors</span>
            </div>
            <div className="hero-trust-divider" />
            <div className="hero-trust-item">
        ...
        <div className="hero-visual" aria-hidden="true">
          <div className="hero-card hero-card-main">
            <div className="hero-card-header">
              <div>
                <span className="hero-card-title">Wellbeing Overview</span>
                <span className="hero-card-subtitle">Last 7 days</span>
              </div>
